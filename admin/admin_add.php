        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000) {
                    ...
                    $query = "INSERT INTO group_requests (title, desc_grp, facility_use, num_par, event_dt, start_grp, end_grp, req_name, email_add, con_num, doc_upl, remarks)
                    VALUES ('$title', '$description', '$facility_name', '$num_participants', '$date_grp', '$start_grp', '$end_grp', '$rname', '$email_grp', '$con_num', '$fileNameNew', '$remarks')";
